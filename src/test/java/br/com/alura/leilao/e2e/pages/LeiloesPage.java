...
public class LeiloesPage {
	...
	public DetalhesDoLeilaoPage visitaPaginaDoLeilaoDo(String donoDoLeilao) throws Exception {
		...
		String xpath = "//table[@class='table table-hover']/tbody/tr/td[contains(text(),'" + donoDoLeilao
				+ "')]/following-sibling::td/a";

		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));

		WebElement href = driver.findElement(By.xpath(xpath));
	...
	public void esperaCarregar() {
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Leilões cadastrados')]")));
	}
